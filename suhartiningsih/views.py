...
from suhartiningsihcart.models import Transaksi, DetailTransaksi
...
from suhartiningsihcart.forms import CartAddProductForm
from suhartiningsihcart.keranjang import Cart
import datetime
...
class CheckoutView(View):
    ...
    def post(self, request):
        ...
        if nama_depan=="":
            ...
            context['has_error'] = True
        if nama_belakang=="":
            messages.error(request, 'Nama Belakang Masih kosong')
            context['has_error'] = True
        if alamat=="":
        ...
        for r in keranjang:
            instance_detail= DetailTransaksi(no_transaksi = no_transaksi,
                                             produk = r['product'],
                                             jumlah = r['quantity'],)
